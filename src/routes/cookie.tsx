    ...
    >
      ...
      <LegalSection title="2. Правовая основа">
        <p>
          ...
          которое выражается нажатием кнопки в информационном баннере либо продолжением использования
          сайта, а также в соответствии с Федеральным законом № 152-ФЗ и Федеральным законом № 149-ФЗ
      ...
      <LegalSection title="4. Срок хранения">
        <p>
          Сессионные cookie удаляются при закрытии браузера, постоянные — хранятся до 12 месяцев либо
          до их удаления пользователем.
        </p>
      </LegalSection>
