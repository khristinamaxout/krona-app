...
function Faq() {
  const items = [
    {
      q: "Сколько зарабатывает партнёр и как считается вознаграждение?",
      a: "Ставка — от 10 до 15% от стоимости мебельной части проекта, без вычетов на доставку и монтаж. Процент фиксируется в договоре и не пересматривается «задним числом». Считаем от итоговой суммы сметы, которую клиент подписал: чем сложнее и дороже проект, тем выше ваша часть. Выплата — в течение 5 рабочих дней после финального платежа клиента, по акту.",
    },
    {
      q: "Можно ли увеличить маржу на своих проектах?",
      a: "Да. Вы можете работать по партнёрской ставке и закладывать собственную наценку сверху — мы не показываем клиенту нашу внутреннюю смету и не обсуждаем с ним ваши условия. Для системных партнёров открываем закрытый прайс на материалы и фурнитуру, что даёт дополнительный запас по бюджету проекта.",
    },
    {
      q: "Сколько занимает запуск: от знакомства до первого объекта?",
      a: "Знакомство и обсуждение — 1 встреча. Просчёт по вашему проекту — 2–3 рабочих дня. Замер — в течение недели, по вашему графику сдачи объекта. Производство типовой кухни или гардеробной — 30–35 рабочих дней, сложные проекты — до 50. Монтаж — 1–3 дня. Сроки фиксируются в договоре до старта, а не сообщаются постфактум.",
    },
    {
      q: "Что, если сроки объекта горят?",
      a: "Скажем честно до подписания: успеваем или нет. Для партнёров с договором действует приоритет в загрузке производства — ваш проект встаёт в очередь выше разовых заказов. Если по объективным причинам срок сдвигается, вы узнаёте об этом первым и заранее, вместе с новым планом.",
    },
    {
      q: "Как устроена поддержка после сдачи проекта?",
      a: "За вами закреплён персональный проектный менеджер и закрытый чат, где отвечают в рабочее время в течение часа. Все обращения клиента по изделию — регулировки, замена фурнитуры, сервисные выезды — идут напрямую к нам в течение 5 лет гарантийного обслуживания. Вам не придётся быть переговорщиком между клиентом и производством.",
    },
    {
      q: "Вы не уведёте моего клиента?",
      a: "Нет. Это зафиксировано в договоре отдельным пунктом. Мы не оставляем визиток, не размещаем логотип в интерьере и не выходим на клиента напрямую по будущим проектам. Автором проекта в глазах клиента остаётесь вы — и мы считаем это условием долгой работы, а не любезностью.",
    },
  ];
  return (
    <section id="faq" className="border-t border-black/10 bg-[#F5F3EE]">
